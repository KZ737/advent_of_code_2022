...
'''
Read the first 3 blueprints' data into a dict.
'''
...
'''
We iterate through all 3 blueprints and take the product of the number of their maximum geodes.
'''
prod = 1
for blueprintID, blueprint in blueprints.items():
    prod *= getMaxGeode(blueprint)

...
Get the last numOfMoves characters of the string at moveFrom, reverse them, and append them to the string at moveTo, then remove the substring from moveFrom.
'''
for line in inputfile:
    ...
    if m:
        ...
        movedString = stacks[moveFrom][len(stacks[moveFrom])-numOfMoves:][::-1]
